...
/**
 * 类名 ：DragGridView.java
 * 功能 ：能够拖动的gridview的Item
 * 作者 ： wanny
 * 时间 ：2015年5月4日上午9:04:20
 */
public class DragGridView extends GridView {
	...
	private OnDragGridBaseAdapter mDragAdapter;
	...
	public void setAdapter(ListAdapter adapter) {
		...
		if(adapter instanceof OnDragGridBaseAdapter){
			mDragAdapter = (OnDragGridBaseAdapter) adapter;
		}else{
