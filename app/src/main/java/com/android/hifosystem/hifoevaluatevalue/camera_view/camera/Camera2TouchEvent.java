...
package com.android.hifosurvey.smarttool.camera;
...
*/
/**
 * 文件名： Camera2TouchEvent
 * 功能：
 * 作者： wanny
 * 时间： 13:53 2016/7/6
 *//*

public class Camera2TouchEvent  {
    ...
    public Camera2TouchEvent(CameraCharacteristics mCameraCharacteristics, TextureView mTextureView, CaptureRequest.Builder mPreviewBuilder, CameraCaptureSession mCameraCaptureSession, Handler mHandler, CameraCaptureSession.CaptureCallback mPreviewSessionCallback) {
